...
class GoalsTestCase(SWTestCase):
    ...
    def test_creating_goals(self):
        ...
        self.assertTrue('id' in result.data['viewer']['goals']['edges'][0]['node'])
        self.assertTrue('monthlyAmount' in result.data['viewer']['goals']['edges'][0]['node'])
        self.assertEqual(
            result.data['viewer']['goals']['edges'][0]['node']['monthlyAmount'], -500)
        self.assertTrue('name' in result.data['viewer']['goals']['edges'][0]['node'])
        self.assertEqual(
            result.data['viewer']['goals']['edges'][0]['node']['name'], 'Spend-Very Well')
    ...
    def test_updating_goals(self):
        ...
        # Validates clientMutationId of the goal
        self.assertEqual(result.data['updateGoal']['clientMutationId'], 'abcd123')
        self.assertTrue('updateGoal' in result.data)
        self.assertTrue('clientMutationId' in result.data['updateGoal'])

        self.assertEqual(
            len(resultForDB.data['viewer']['goals']['edges']),
            1
        )
        # checking key and values specifics using GraphQl
        self.assertTrue('viewer' in resultForDB.data)
        self.assertTrue('goals' in resultForDB.data['viewer'])
        self.assertTrue('edges' in resultForDB.data['viewer']['goals'])
        self.assertTrue('node' in resultForDB.data['viewer']['goals']['edges'][0])
        self.assertTrue('id' in resultForDB.data['viewer']['goals']['edges'][0]['node'])
        self.assertTrue('monthlyAmount' in resultForDB.data['viewer']['goals']['edges'][0]['node'])
        self.assertEqual(
            resultForDB.data['viewer']['goals']['edges'][0]['node']['monthlyAmount'], -1000)
        self.assertTrue('name' in resultForDB.data['viewer']['goals']['edges'][0]['node'])
        self.assertEqual(
            resultForDB.data['viewer']['goals']['edges'][0]['node']['name'], 'SpendIt-Very Well')
    ...
    def test_deleting_goals(self):
        ...
        # Validates clientMutationId of the goal
        self.assertEqual(result.data['deleteGoal']['clientMutationId'], 'ABCDabcd123')
